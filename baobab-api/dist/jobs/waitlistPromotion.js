...
exports.checkAndPromoteWaitlist = checkAndPromoteWaitlist;
const client_1 = require("@prisma/client");
const taxonomy_1 = require("../config/taxonomy");
const prisma = new client_1.PrismaClient();
async function checkAndPromoteWaitlist() {
    ...
    try {
        ...
        if (waitlisted.length === 0) {
            console.log('[CRON] Aucun projet en attente');
            return;
        }
        ...
        for (const project of waitlisted) {
            ...
            if (validActive.length < taxonomy_1.MAX_ACTIVE_PER_SUBSECTOR) {
...
//# sourceMappingURL=waitlistPromotion.js.map