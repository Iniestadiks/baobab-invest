...
exports.computeMonthlyRankings = computeMonthlyRankings;
// @ts-nocheck
const client_1 = require("@prisma/client");
const reputationService_1 = require("../services/reputationService");
const prisma = new client_1.PrismaClient();
async function computeMonthlyRankings() {
    const now = new Date();
    ...
    try {
        ...
        if (investorScores.length > 0) {
            ...
            await (0, reputationService_1.awardBadge)(topInvestor, "INVESTOR_MONTH");
        ...
        if (entrScores.length > 0) {
            ...
            await (0, reputationService_1.awardBadge)(topEntr, "ENTREPRENEUR_MONTH");
            await prisma.notification.create({
                data: {
                    userId: topEntr,
...
//# sourceMappingURL=monthlyRankings.js.map