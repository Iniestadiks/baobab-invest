...
exports.COURSE_CATALOG = void 0;
exports.getCoursesForRole = getCoursesForRole;
exports.getCourse = getCourse;
exports.COURSE_CATALOG = [
    // ── ENTREPRENEUR ──
    {
        id: 'gestion-base',
...
function getCoursesForRole(role) {
    return exports.COURSE_CATALOG.filter(c => c.targetRole.includes('ALL') || c.targetRole.includes(role));
}
function getCourse(id) {
    return exports.COURSE_CATALOG.find(c => c.id === id);
}
//# sourceMappingURL=academyCourses.js.map