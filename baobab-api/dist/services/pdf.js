...
function generateInvestmentCertificate(res, data) {
    ...
    doc.fillColor(DARK).fontSize(9).font('Helvetica')
        .text('Ce document certifie la participation de l\'investisseur au projet mentionne ci-dessus sur la plateforme KORAPACT. Les fonds sont securises en sequestre jusqu\'au remboursement conformement aux conditions generales.', 50, boxY + 8, { width: doc.page.width - 100, align: 'center' });
    footer(doc);
    doc.end();
}
// ============================================
