...
exports.generateInvestmentCertificate = generateInvestmentCertificate;
exports.generateInvestorStatement = generateInvestorStatement;
exports.generateProjectReport = generateProjectReport;
exports.generateMentorReport = generateMentorReport;
exports.generateAdminReport = generateAdminReport;
exports.generateBuilderReport = generateBuilderReport;
...
// ============================================
function generateInvestmentCertificate(res, data) {
    ...
    doc.fillColor(DARK).fontSize(9).font('Helvetica')
        .text('Ce document certifie la participation de l\'investisseur au projet mentionne ci-dessus sur la plateforme BAOBAB INVEST. Les fonds sont securises en sequestre jusqu\'au remboursement conformement aux conditions generales.', 50, boxY + 8, { width: doc.page.width - 100, align: 'center' });
    footer(doc);
    doc.end();
}
// ============================================
...
// ============================================
function generateInvestorStatement(res, data) {
    const doc = new pdfkit_1.default({ size: 'A4', margin: 40 });
    res.setHeader('Content-Type', 'application/pdf');
    ...
    data.investments.forEach((inv, i) => {
        ...
        const rowY = doc.y;
        if (i % 2 === 0)
            doc.rect(40, rowY - 2, doc.page.width - 80, 18).fill(LIGHT_GRAY);
...
// ============================================
function generateProjectReport(res, data) {
    const doc = new pdfkit_1.default({ size: 'A4', margin: 40 });
    res.setHeader('Content-Type', 'application/pdf');
...
// RAPPORT MENTOR
// ============================================
function generateMentorReport(res, data) {
    const doc = new pdfkit_1.default({ size: 'A4', margin: 40 });
    res.setHeader('Content-Type', 'application/pdf');
...
// RAPPORT ADMIN
// ============================================
function generateAdminReport(res, data) {
    const doc = new pdfkit_1.default({ size: 'A4', margin: 40 });
    res.setHeader('Content-Type', 'application/pdf');
...
// RAPPORT BÂTISSEUR
// ============================================
function generateBuilderReport(res, data) {
    const doc = new pdfkit_1.default({ size: 'A4', margin: 40 });
    res.setHeader('Content-Type', 'application/pdf');
