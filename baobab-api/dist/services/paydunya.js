...
exports.initPayin = initPayin;
exports.checkPayin = checkPayin;
exports.initPayout = initPayout;
...
async function checkPayin(token) {
...
async function initPayout(data) {
    const operatorMap = {
