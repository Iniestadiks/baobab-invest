...
exports.ensurePaymentProviderConfigs = ensurePaymentProviderConfigs;
...
const paydunya_adapter_1 = require("./paydunya-adapter");
const kiakiapay_adapter_1 = require("./kiakiapay-adapter");
const stripe_adapter_1 = require("./stripe-adapter");
const prisma = new client_1.PrismaClient();
const ALL_PROVIDERS = {
    paydunya: paydunya_adapter_1.paydunyaProvider,
    kiakiapay: kiakiapay_adapter_1.kiakiapayProvider,
    stripe: stripe_adapter_1.stripeProvider,
};
...
async function ensurePaymentProviderConfigs() {
