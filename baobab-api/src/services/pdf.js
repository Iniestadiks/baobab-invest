...
// ============================================
export function generateInvestmentCertificate(res, data) {
...
// ============================================
export function generateInvestorStatement(res, data) {
    const doc = new PDFDocument({ size: 'A4', margin: 40 });
    res.setHeader('Content-Type', 'application/pdf');
...
// ============================================
export function generateProjectReport(res, data) {
    const doc = new PDFDocument({ size: 'A4', margin: 40 });
    res.setHeader('Content-Type', 'application/pdf');
...
// RAPPORT MENTOR
// ============================================
export function generateMentorReport(res, data) {
    const doc = new PDFDocument({ size: 'A4', margin: 40 });
    res.setHeader('Content-Type', 'application/pdf');
...
// RAPPORT ADMIN
// ============================================
export function generateAdminReport(res, data) {
    const doc = new PDFDocument({ size: 'A4', margin: 40 });
    res.setHeader('Content-Type', 'application/pdf');
...
// RAPPORT BÂTISSEUR
// ============================================
export function generateBuilderReport(res, data) {
    const doc = new PDFDocument({ size: 'A4', margin: 40 });
    res.setHeader('Content-Type', 'application/pdf');
