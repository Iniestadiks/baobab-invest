...
// ===== AJOUTER DES POINTS =====
export async function addReputationPoints(userId, type, points, description, projectId) {
    try {
...
// ===== ATTRIBUER UN BADGE =====
export async function awardBadge(userId, badgeKey, projectId) {
    try {
...
export async function checkAndAwardBadges(userId, role) {
    try {
