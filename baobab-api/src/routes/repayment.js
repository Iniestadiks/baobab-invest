...
router.get('/investor/received', authenticate, async (req, res) => {
    try {
...
router.post('/create/:projectId', authenticate, async (req, res) => {
    try {
...
router.post('/pay/:scheduleId', authenticate, requireRole(['ENTREPRENEUR']), async (req, res) => {
    try {
...
router.patch('/admin/reschedule/:scheduleId', authenticate, requireRole(['ADMIN']), async (req, res) => {
    try {
...
router.post('/pay-advance/:scheduleId', authenticate, requireRole(['ENTREPRENEUR']), async (req, res) => {
    try {
...
router.post('/check-delays', authenticate, async (req, res) => {
    try {
        const now = new Date();
...
router.post('/project-failed/:projectId', authenticate, async (req, res) => {
    try {
