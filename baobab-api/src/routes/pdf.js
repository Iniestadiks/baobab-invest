...
import { generateInvestmentCertificate, generateInvestorStatement, generateProjectReport, generateAdminReport, generateMentorReport, generateBuilderReport } from '../services/pdf';
const router = Router();
// Certificat d'investissement — par investisseur
router.get('/certificate/:investmentId', authenticate, async (req, res) => {
    try {
...
router.get('/statement/investor', authenticate, async (req, res) => {
    try {
...
router.get('/report/project/:projectId', authenticate, async (req, res) => {
    try {
...
// Rapport mentor
router.get('/report/mentor', authenticate, async (req, res) => {
    try {
...
// Rapport admin
router.get('/report/admin', authenticate, requireAdmin, async (req, res) => {
    try {
...
router.get('/report/entrepreneur', authenticate, async (req, res) => {
    try {
...
router.get('/builder/report', authenticate, async (req, res) => {
    try {
