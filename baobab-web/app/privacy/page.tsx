      ...
      <div style={{minHeight:"100vh",background:"var(--dark)",paddingTop:68}}>
        <div style={{background:"linear-gradient(180deg,rgba(139,92,246,0.08) 0%,transparent 100%)",borderBottom:"1px solid rgba(255,255,255,0.07)",padding:"64px 32px 48px"}}>
          <div style={{maxWidth:1280,margin:"0 auto"}}>
            ...
            <h1 style={{fontSize:"clamp(32px,5vw,56px)",fontWeight:900,letterSpacing:"-2px",marginBottom:16}}>Politique de<br/><span style={{background:"linear-gradient(135deg,#8B5CF6,#22c55e)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",backgroundClip:"text"}}>Confidentialité</span></h1>
        ...
        <div style={{maxWidth:1280,margin:"0 auto",padding:"64px 32px",display:"grid",gridTemplateColumns:"260px 1fr",gap:48,alignItems:"start"}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:24}}>
            ...
            <div style={{background:"linear-gradient(135deg,rgba(139,92,246,0.12),rgba(34,197,94,0.08))",border:"1px solid rgba(139,92,246,0.2)",borderRadius:24,padding:40,textAlign:"center"}}>
