              ...
              return (
                <div key={s.id} style={{display:"flex",alignItems:"center",gap:8}}>
                  <div style={{display:"flex",alignItems:"center",gap:8}}>
                    ...
                    <span style={{fontSize:12.5,fontWeight:isActive?700:500,color:isActive?"#fff":"rgba(255,255,255,0.4)"}}>{s.label}</span>
                  </div>
                  {i === 0 && <div style={{width:32,height:2,borderRadius:2,background: isDone ? "#22c55e" : "rgba(255,255,255,0.1)"}}/>}
                </div>
              );
            })}
          </div>
          ...
          {step === "info" && (
            <form onSubmit={handleRegister}>
              ...
              <div style={{marginBottom:14,background:"linear-gradient(135deg,rgba(37,99,235,0.05),rgba(6,182,212,0.03))",border:"1px solid rgba(255,255,255,0.08)",borderRadius:18,padding:18}}>
                ...
                <style>{`
                  .geo-dark select,.geo-dark input{
                  ...
                  .geo-dark > div:last-child{margin-bottom:0}
                `}</style>
