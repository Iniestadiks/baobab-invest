                        ...
                        <div className="mt-2">
                          ...
                          <div className="grid grid-cols-6 gap-1">
                            {schedules[inv.projectId].payments?.map((pay: any) => {
                              ...
                              const payinPct = inv.project?.feePayinRepaymentRate ?? (fees?.payin_repayment || 4)
        ...
        {activeTab === "wallet" && (
          <div className="space-y-5 max-w-2xl">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-5">
              ...
              <div className="space-y-3">
                {[
                  { label: "📈 Gains remboursements", value: fmt(gainBalance) + " FCFA", color: "text-green-700", note: `Retrait ${fees?.withdrawal_fee_standard ?? 3}%` },
                  { label: "💵 Dépôts à investir", value: fmt(depositBalance) + " FCFA", color: "text-orange-600", note: `Retrait ${fees?.withdrawal_fee_no_invest ?? 7}% si non investi` },
