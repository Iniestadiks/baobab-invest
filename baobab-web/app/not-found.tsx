  ...
  return (
    <>
      ...
      <div style={{minHeight:"100vh",background:"var(--dark)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:32,textAlign:"center",position:"relative",overflow:"hidden",paddingTop:68}}>
        <div style={{position:"absolute",width:700,height:700,borderRadius:"50%",background:"radial-gradient(circle,rgba(37,99,235,0.07) 0%,transparent 70%)",top:"50%",left:"50%",transform:"translate(-50%,-50%)",pointerEvents:"none"}}/>
        <div style={{position:"relative",zIndex:1}}>
          <div style={{fontSize:"clamp(100px,20vw,200px)",fontWeight:900,lineHeight:1,letterSpacing:"-8px",background:"linear-gradient(135deg,rgba(37,99,235,0.6),rgba(6,182,212,0.4))",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",backgroundClip:"text",marginBottom:8}}>404</div>
          <div style={{width:80,height:3,background:"linear-gradient(90deg,#2563EB,#06B6D4)",borderRadius:2,margin:"0 auto 32px"}}/>
